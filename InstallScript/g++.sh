...
/usr/sbin/update-alternatives --install  /usr/bin/gcc gcc /usr/local/bin/x86_64-pc-linux-gnu-g++ 72
/usr/sbin/update-alternatives --install  /usr/bin/cc cc /usr/local/bin/x86_64-pc-linux-gnu-g++ 72
